...
import com.postingapp.android.Constants;
...
import com.postingapp.android.managers.DatabaseHelper;
import com.postingapp.android.managers.PostManager;
import com.postingapp.android.managers.ProfileManager;
import com.postingapp.android.managers.listeners.OnObjectChangedListener;
import com.postingapp.android.managers.listeners.OnObjectChangedListenerSimple;
import com.postingapp.android.managers.listeners.OnObjectExistListener;
import com.postingapp.android.model.Like;
...
//    private TextView titleTextView;
    ...
    public PostViewHolder(View view, final OnClickListener onClickListener, BaseActivity activity, boolean isAuthorNeeded) {
        ...
        userNameView = view.findViewById(R.id.userNameTxt);
        ...
        dateTextView = view.findViewById(R.id.timestampTxt);
...
//        titleTextView.setText(title);
        ...
        DatabaseHelper databaseHelper = DatabaseHelper.getInstance(Common.currentActivity);
        DatabaseReference databaseReference = databaseHelper.getDatabaseReference().child(DatabaseHelper.PROFILES_DB_KEY).child(post.getAuthorId());
        ...
        if (profile != null) {
            postManager.hasCurrentUserLikeSingleValue(post.getId(), profile.getId(), createOnLikeObjectExistListener());
        }
    }
