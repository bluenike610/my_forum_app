...
import com.postingapp.android.managers.listeners.OnPostListChangedListener;
import com.postingapp.android.managers.listeners.OnTaskCompleteListener;
import com.postingapp.android.model.Like;
import com.postingapp.android.model.Post;
import com.postingapp.android.model.PostListResult;
...
public class PostInteractor {
    ...
    private boolean isPostValid(Map<String, Object> post) {
        return post.containsKey("description")
