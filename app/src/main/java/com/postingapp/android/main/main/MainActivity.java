...
import com.postingapp.android.adapters.PostsAdapter;
import com.postingapp.android.config.Config;
...
import com.postingapp.android.main.followPosts.FollowingPostsActivity;
...
import com.postingapp.android.main.search.SearchActivity;
...
//        query.insertUser(user);
        ...
        FirebaseAuth.getInstance().signInWithEmailAndPassword(Config.FIREBASE_EMAIL,
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        Task<Void> task2 = databaseHelper
